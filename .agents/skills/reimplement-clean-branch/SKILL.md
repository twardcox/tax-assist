...
name: reimplement-clean-branch
description: Replay branch with clean history; MCP ce://commands/reimplement-clean-branch
disable-model-invocation: true
---

# CE: `reimplement-clean-branch`
...
2. Load the canonical playbook text:
   - Call **`resources/read`** with URI **`ce://commands/reimplement-clean-branch`** (plural `commands`), **or**
   - Call **`get_slash_command`** with **`command_name`:** **`reimplement-clean-branch`**
...
- Retry with **`get_slash_command`** and `reimplement-clean-branch`.
