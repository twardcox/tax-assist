...
name: create-milestone-prd
description: Generate Milestone PRD from System PRD; get_slash_command: create-milestone-prd
disable-model-invocation: true
---

# CE: `create-milestone-prd`
...
2. Load the canonical playbook text:
   - Call **`resources/read`** with URI **`ce://commands/create-milestone-prd`** (plural `commands`), **or**
   - Call **`get_slash_command`** with **`command_name`:** **`create-milestone-prd`**
...
- Retry with **`get_slash_command`** and `create-milestone-prd`.
