...
name: sequential-commit
description: Logical commits; MCP ce://commands/sequential-commit
disable-model-invocation: true
---

# CE: `sequential-commit`
...
2. Load the canonical playbook text:
   - Call **`resources/read`** with URI **`ce://commands/sequential-commit`** (plural `commands`), **or**
   - Call **`get_slash_command`** with **`command_name`:** **`sequential-commit`**
...
- Retry with **`get_slash_command`** and `sequential-commit`.
