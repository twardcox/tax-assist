...
description: Edits to existing spec docs (ACs, copy) only - not new scope; get_slash_command: lightweight-change
disable-model-invocation: true
---

# CE: `lightweight-change`
...
2. Load the canonical playbook text:
   - Call **`resources/read`** with URI **`ce://commands/lightweight-change`** (plural `commands`), **or**
   - Call **`get_slash_command`** with **`command_name`:** **`lightweight-change`**
...
- Retry with **`get_slash_command`** and `lightweight-change`.
