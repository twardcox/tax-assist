...
description: Break a milestone into epics and user stories; get_slash_command: breakdown-milestone
disable-model-invocation: true
---

# CE: `breakdown-milestone`
...
2. Load the canonical playbook text:
   - Call **`resources/read`** with URI **`ce://commands/breakdown-milestone`** (plural `commands`), **or**
   - Call **`get_slash_command`** with **`command_name`:** **`breakdown-milestone`**
...
- Retry with **`get_slash_command`** and `breakdown-milestone`.
