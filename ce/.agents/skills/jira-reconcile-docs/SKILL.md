...
name: Tracker-reconcile-docs
description: Reconcile Tracker vs CE docs (agent-docs + specs/tasks); surface out-of-band tickets; optionally annotate + label; get_slash_command: Tracker-reconcile-docs
disable-model-invocation: true
---

# CE: `Tracker-reconcile-docs`
...
2. Load the canonical playbook text:
   - Call **`resources/read`** with URI **`ce://commands/Tracker-reconcile-docs`** (plural `commands`), **or**
   - Call **`get_slash_command`** with **`command_name`:** **`Tracker-reconcile-docs`**
...
- Retry with **`get_slash_command`** and `Tracker-reconcile-docs`.
