...
name: create-prd-tickets
description: Create Tracker epics and stories from a Milestone PRD; get_slash_command: create-prd-tickets
disable-model-invocation: true
---

# CE: `create-prd-tickets`
...
2. Load the canonical playbook text:
   - Call **`resources/read`** with URI **`ce://commands/create-prd-tickets`** (plural `commands`), **or**
   - Call **`get_slash_command`** with **`command_name`:** **`create-prd-tickets`**
...
- Retry with **`get_slash_command`** and `create-prd-tickets`.
