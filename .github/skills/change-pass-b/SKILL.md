...
name: change-pass-b
description: Scope-change step 3: updated backlog proposal → updated-epics-and-tickets.md; get_slash_command: change-pass-b
...
2. Load the canonical playbook text:
   - Call **`resources/read`** with URI **`ce://commands/change-pass-b`** (plural `commands`), **or**
...
- Retry with **`get_slash_command`** and `change-pass-b`.
